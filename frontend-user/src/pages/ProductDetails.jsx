  ...
  useEffect(() => {
    const fetchFullData = async () => {
      try {
        ...
        const catId = mainProduct.id_categorie;
        ...
        const filteredRecs = allProducts
          .filter(p => p.id_categorie === catId && p.id_product !== parseInt(id))
          .slice(0, 4); 
    ...
    <div className="bg-[#F8FAFC] min-h-screen pb-20">
      <div className="container mx-auto px-6 py-10 text-left">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-400 mb-8">
          <Link to="/" className="hover:text-pacific">Accueil</Link>
        ...
        <div className="mt-20">
          <h2 className="text-2xl font-black text-slate-blue mb-10 uppercase tracking-tighter">
            Produits <span className="text-pacific">Similaires</span>
          </h2>
